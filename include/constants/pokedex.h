...
enum NationalDexOrder
{
    ...
    NATIONAL_DEX_SKOGSRA,
    NATIONAL_DEX_ALRAUNE,
    NATIONAL_DEX_CIRONNUP,
    NATIONAL_DEX_KUDA,
    NATIONAL_DEX_CHEFEI,
    NATIONAL_DEX_ZOA,
    NATIONAL_DEX_GOGMAGOG,
    NATIONAL_DEX_ALBION,
    NATIONAL_DEX_PASCAL,
    NATIONAL_DEX_ORTHRUS,
    NATIONAL_DEX_CERBERUS,
    NATIONAL_DEX_KOPPA_TENGU,
    NATIONAL_DEX_KARASU_TENGU,
    NATIONAL_DEX_KURAMA_TENGU,
    NATIONAL_DEX_PIXIE,
    NATIONAL_DEX_HIGH_PIXIE,
    NATIONAL_DEX_QUEEN_MAB,
    NATIONAL_DEX_SLIME,
    NATIONAL_DEX_BLACK_OOZE,
    NATIONAL_DEX_GOBLIN,
    NATIONAL_DEX_DWARF,
    NATIONAL_DEX_ONGKHOT,
    NATIONAL_DEX_HANUMAN,
    NATIONAL_DEX_SUN_WUKONG,
    NATIONAL_DEX_CHATTERSKULL,
    NATIONAL_DEX_LOA,
    NATIONAL_DEX_PETIT_FROST,
    NATIONAL_DEX_JACK_FROST,
    NATIONAL_DEX_KING_FROST,
    NATIONAL_DEX_BLACK_FROST,
    NATIONAL_DEX_JACK_O_LANTERN,
    NATIONAL_DEX_JACK_THE_RIPPER,
    NATIONAL_DEX_UBU,
    NATIONAL_DEX_TSUCHIGUMO,
    NATIONAL_DEX_MOTHMAN,
    NATIONAL_DEX_AGATHION,
    NATIONAL_DEX_BROWNIE,
    NATIONAL_DEX_BOGLE,
    NATIONAL_DEX_KOROPOKKUR,
    NATIONAL_DEX_SUKUNA_HIKONA,
    NATIONAL_DEX_MORAX,
    NATIONAL_DEX_MINOTAUR,
    NATIONAL_DEX_ANANSI,
    NATIONAL_DEX_ONYANKOPON,
    NATIONAL_DEX_NYAMI_NYAMI,
    NATIONAL_DEX_ANGEL,
    NATIONAL_DEX_ARCHANGEL,
    NATIONAL_DEX_ZHU_TUN_SHE,
    NATIONAL_DEX_NEKOMATA,
    NATIONAL_DEX_SENRI,
    NATIONAL_DEX_AMABIE,
    NATIONAL_DEX_KINMAMON,
    NATIONAL_DEX_BAKU,
    NATIONAL_DEX_BUG,
    NATIONAL_DEX_HAG,
    NATIONAL_DEX_TURBO_GRANNY,
    NATIONAL_DEX_AMMUT,
    NATIONAL_DEX_SOBEK,
    NATIONAL_DEX_DEAD_LOBSTER,
    NATIONAL_DEX_FAUN,
    NATIONAL_DEX_SANDMAN,
    NATIONAL_DEX_GAGYSON,
    NATIONAL_DEX_ORIAS,
    NATIONAL_DEX_ONI,
    NATIONAL_DEX_ES,
    NATIONAL_DEX_AMDUSIAS,
    NATIONAL_DEX_MITAMA,
    NATIONAL_DEX_CHRIS_THE_CAR,
    NATIONAL_DEX_AKA_MANAH,
    NATIONAL_DEX_ANGRA_MAINYU,
    NATIONAL_DEX_VOHU_MANAH,
    NATIONAL_DEX_SRAOSHA,
    NATIONAL_DEX_MADA,
    NATIONAL_DEX_ALILAT,
    NATIONAL_DEX_KAMAPUAA,
    NATIONAL_DEX_PELE,
    NATIONAL_DEX_ATTIS,
    NATIONAL_DEX_DIONYSUS,
    NATIONAL_DEX_NOZUCHI,
    NATIONAL_DEX_CATOBLEPAS,
    NATIONAL_DEX_NEKO_SHOGUN,
    NATIONAL_DEX_YOSHITSUNE,
    NATIONAL_DEX_THRONE,
    NATIONAL_DEX_CHERUB,
    NATIONAL_DEX_SERAPH,
    NATIONAL_DEX_MOMUNOFU,
    NATIONAL_DEX_ARAHABAKI,
    NATIONAL_DEX_THUNDERBIRD,
    NATIONAL_DEX_HARE_OF_INABA,
    NATIONAL_DEX_YOWIE,
    NATIONAL_DEX_MYRMECOLEON,
    NATIONAL_DEX_OSHIRA_SAMA,
    NATIONAL_DEX_KAYA_NO_HIME,
    NATIONAL_DEX_KONOHANA_SAKUYA,
    NATIONAL_DEX_OUYAMATSUMI,
    NATIONAL_DEX_CABRACAN,
    NATIONAL_DEX_GUCUMATZ,
    NATIONAL_DEX_WENDIGO,
    NATIONAL_DEX_LILIM,
    NATIONAL_DEX_LILITH,
    NATIONAL_DEX_BELIAL,
    NATIONAL_DEX_NEBIROS,
    NATIONAL_DEX_ITSUMADE,
    NATIONAL_DEX_GURULU,
    NATIONAL_DEX_OBERON,
    NATIONAL_DEX_TITANIA,
    NATIONAL_DEX_FAFNIR,
    NATIONAL_DEX_OCELOT,
    NATIONAL_DEX_TEZCATLIPOCA,
    NATIONAL_DEX_NARCISSUS,
    NATIONAL_DEX_CHERNOBOG,
    NATIONAL_DEX_TLALOC,
    NATIONAL_DEX_OMETEOTL,
    NATIONAL_DEX_NAGA,
    NATIONAL_DEX_NAGA_RAJA,
    NATIONAL_DEX_VASUKI,
    NATIONAL_DEX_NIGHT_STALKER,
    NATIONAL_DEX_MAD_GASSER,
    NATIONAL_DEX_SKELETON,
    ...
    NATIONAL_DEX_GNOME,
    NATIONAL_DEX_BARBEGAZI,
    NATIONAL_DEX_ZEED,
    NATIONAL_DEX_OBARIYON,
    NATIONAL_DEX_PUTZ,
    NATIONAL_DEX_THOR,
    NATIONAL_DEX_ODIN,
    NATIONAL_DEX_LOKI,
    NATIONAL_DEX_HEL,
    NATIONAL_DEX_YUKI_JYOROU,
    NATIONAL_DEX_LOUP_GAROU,
    NATIONAL_DEX_DAGDA,
    NATIONAL_DEX_AZUMI,
    NATIONAL_DEX_ISORA,
    NATIONAL_DEX_FORNEUS,
    NATIONAL_DEX_DECARABIA,
    NATIONAL_DEX_SETANTA,
    NATIONAL_DEX_CU_CHULAINN,
    NATIONAL_DEX_AIRAVATA,
    NATIONAL_DEX_GIRIMEKHALA,
    NATIONAL_DEX_THANATOS,
    NATIONAL_DEX_MOT,
    NATIONAL_DEX_THOTH,
    NATIONAL_DEX_KHONSU,
    ...
    NATIONAL_DEX_BAIHU,
    NATIONAL_DEX_XUANWU,
    NATIONAL_DEX_QING_LONG,
    NATIONAL_DEX_ZHUQUE,
    NATIONAL_DEX_HUANG_LONG,
    NATIONAL_DEX_BEELZEBUB,
    NATIONAL_DEX_METATRON,
    NATIONAL_DEX_AMANOZAKO,
    NATIONAL_DEX_SHIVA,
    NATIONAL_DEX_DANTE,
};
...
#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI
    ...
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_DANTE
...
enum HoennDexOrder
{
    ...
    HOENN_DEX_ORTHRUS,
    HOENN_DEX_CERBERUS,
    HOENN_DEX_KOPPA_TENGU,
    HOENN_DEX_KARASU_TENGU,
    HOENN_DEX_KURAMA_TENGU,
    HOENN_DEX_PIXIE,
    HOENN_DEX_HIGH_PIXIE,
    HOENN_DEX_QUEEN_MAB,
    HOENN_DEX_SLIME,
    HOENN_DEX_BLACK_OOZE,
    HOENN_DEX_GOBLIN,
    HOENN_DEX_DWARF,
    HOENN_DEX_ONGKHOT,
    HOENN_DEX_HANUMAN,
    HOENN_DEX_SUN_WUKONG,
    HOENN_DEX_CHATTERSKULL,
    HOENN_DEX_LOA,
    HOENN_DEX_PETIT_FROST,
    HOENN_DEX_JACK_FROST,
    HOENN_DEX_KING_FROST,
    HOENN_DEX_BLACK_FROST,
    HOENN_DEX_JACK_O_LANTERN,
    HOENN_DEX_JACK_THE_RIPPER,
    HOENN_DEX_UBU,
    HOENN_DEX_TSUCHIGUMO,
    HOENN_DEX_MOTHMAN,
    HOENN_DEX_AGATHION,
    HOENN_DEX_BROWNIE,
    HOENN_DEX_BOGLE,
    HOENN_DEX_KOROPOKKUR,
    HOENN_DEX_SUKUNA_HIKONA,
    HOENN_DEX_MORAX,
    HOENN_DEX_MINOTAUR,
    HOENN_DEX_ANANSI,
    HOENN_DEX_ONYANKOPON,
    HOENN_DEX_NYAMI_NYAMI,
    HOENN_DEX_ANGEL,
    HOENN_DEX_ARCHANGEL,
    HOENN_DEX_ZHU_TUN_SHE,
    HOENN_DEX_NEKOMATA,
    HOENN_DEX_SENRI,
    HOENN_DEX_AMABIE,
    HOENN_DEX_KINMAMON,
    ...
    HOENN_DEX_BUG,
    HOENN_DEX_HAG,
    HOENN_DEX_TURBO_GRANNY,
    HOENN_DEX_AMMUT,
    HOENN_DEX_SOBEK,
    HOENN_DEX_DEAD_LOBSTER,
    HOENN_DEX_FAUN,
    HOENN_DEX_SANDMAN,
    HOENN_DEX_GAGYSON,
    HOENN_DEX_ORIAS,
    ...
    HOENN_DEX_AMDUSIAS,
    HOENN_DEX_MITAMA,
    HOENN_DEX_CHRIS_THE_CAR,
    HOENN_DEX_AKA_MANAH,
    HOENN_DEX_ANGRA_MAINYU,
    HOENN_DEX_VOHU_MANAH,
    HOENN_DEX_SRAOSHA,
    HOENN_DEX_MADA,
    HOENN_DEX_ALILAT,
    HOENN_DEX_KAMAPUAA,
    ...
    HOENN_DEX_DIONYSUS,
    HOENN_DEX_NOZUCHI,
    HOENN_DEX_CATOBLEPAS,
    HOENN_DEX_NEKO_SHOGUN,
    HOENN_DEX_YOSHITSUNE,
    HOENN_DEX_THRONE,
    HOENN_DEX_CHERUB,
    HOENN_DEX_SERAPH,
    HOENN_DEX_MOMUNOFU,
    HOENN_DEX_ARAHABAKI,
    HOENN_DEX_THUNDERBIRD,
    HOENN_DEX_HARE_OF_INABA,
    HOENN_DEX_YOWIE,
    HOENN_DEX_MYRMECOLEON,
    HOENN_DEX_OSHIRA_SAMA,
    HOENN_DEX_KAYA_NO_HIME,
    HOENN_DEX_KONOHANA_SAKUYA,
    HOENN_DEX_OUYAMATSUMI,
    HOENN_DEX_CABRACAN,
    HOENN_DEX_GUCUMATZ,
    HOENN_DEX_WENDIGO,
    HOENN_DEX_LILIM,
    ...
    HOENN_DEX_NAGA_RAJA,
    HOENN_DEX_VASUKI,
    HOENN_DEX_NIGHT_STALKER,
    HOENN_DEX_MAD_GASSER,
    HOENN_DEX_SKELETON,
    HOENN_DEX_MATADOR,
    HOENN_DEX_DAISOUJOU,
    HOENN_DEX_HELL_BIKER,
    HOENN_DEX_TRUMPETER,
    HOENN_DEX_MOTHER_HARLOT,
    HOENN_DEX_GNOME,
    HOENN_DEX_BARBEGAZI,
    HOENN_DEX_ZEED,
    HOENN_DEX_OBARIYON,
    ...
    HOENN_DEX_LOKI,
    HOENN_DEX_HEL,
    HOENN_DEX_YUKI_JYOROU,
    HOENN_DEX_LOUP_GAROU,
    HOENN_DEX_DAGDA,
    HOENN_DEX_AZUMI,
    HOENN_DEX_ISORA,
    HOENN_DEX_FORNEUS,
    HOENN_DEX_DECARABIA,
    HOENN_DEX_SETANTA,
    HOENN_DEX_CU_CHULAINN,
    HOENN_DEX_AIRAVATA,
    HOENN_DEX_GIRIMEKHALA,
    HOENN_DEX_THANATOS,
    HOENN_DEX_MOT,
    HOENN_DEX_THOTH,
    HOENN_DEX_KHONSU,
...
#define HOENN_DEX_COUNT (HOENN_DEX_DANTE + 1)
