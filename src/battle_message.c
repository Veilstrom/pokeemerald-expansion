...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PLAYERWHITEOUT]                       = COMPOUND_STRING("You have no more DEMONS that can fight!\p"),
    ...
    [STRINGID_HITXTIMES]                            = COMPOUND_STRING("The DEMON was hit {B_BUFF1} time(s)!"), //SV has dynamic plural here
    ...
    [STRINGID_FAINTINTHREE]                         = COMPOUND_STRING("All DEMONS that heard the song will faint in three turns!"),
    ...
    [STRINGID_ITDODGEDBALL]                         = COMPOUND_STRING("It dodged your thrown Poké Ball! This DEMON can't be caught!"),
    [STRINGID_YOUMISSEDPKMN]                        = COMPOUND_STRING("You missed the DEMON!"),
    [STRINGID_PKMNBROKEFREE]                        = COMPOUND_STRING("Oh no! The DEMON broke free!"),
    ...
    [STRINGID_PKMNDATAADDEDTODEX]                   = COMPOUND_STRING("{B_DEF_NAME}'s data has been added to the Compendium!\p"),
    ...
    [STRINGID_ENEMYABOUTTOSWITCHPKMN]               = COMPOUND_STRING("{B_TRAINER1_NAME_WITH_CLASS} is about to send out {B_BUFF2}.\pWill you switch your DEMON?"),
    ...
    [STRINGID_USENEXTPKMN]                          = COMPOUND_STRING("Use next DEMON?"),
    ...
    [STRINGID_HELDITEMSLOSEEFFECTS]                 = COMPOUND_STRING("It created a bizarre area in which DEMONS' held items lose their effects!"),
    ...
    [STRINGID_POWDEREXPLODES]                       = COMPOUND_STRING("When the flame touched the powder on the DEMON, it exploded!"),
    ...
    [STRINGID_AURABREAKENTERS]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} reversed all other DEMONS' auras!"),
    ...
    [STRINGID_PKMNSWILLPERISHIN3TURNS]              = COMPOUND_STRING("Both DEMONS will perish in three turns!"),  //don't think this message is displayed anymore
    ...
    [STRINGID_MYSTERIOUSAIRCURRENT]                 = COMPOUND_STRING("Mysterious strong winds are protecting Flying-type DEMONS!"),
    ...
    [STRINGID_BOTHCANNOLONGERESCAPE]                = COMPOUND_STRING("Neither DEMON can run away!"),
    ...
    [STRINGID_ABILITYWEAKENEDSURROUNDINGMONSSTAT]   = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} weakened the {B_BUFF1} of all surrounding DEMONS!\p"),
    ...
    [STRINGID_SHARPSTEELFLOATS]                     = COMPOUND_STRING("Sharp-pointed pieces of steel started floating around {B_DEF_TEAM2} DEMONS!"),
    ...
    [STRINGID_SHARPSTEELDISAPPEAREDFROMTEAM]        = COMPOUND_STRING("The pieces of steel surrounding {B_ATK_TEAM2} DEMONS disappeared!"),
    [STRINGID_TEAMTRAPPEDWITHVINES]                 = COMPOUND_STRING("{B_DEF_TEAM1} DEMONS got trapped with vines!"),
    [STRINGID_PKMNHURTBYVINES]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is hurt by G-Max Vine Lash's ferocious beating!"),
    [STRINGID_TEAMCAUGHTINVORTEX]                   = COMPOUND_STRING("{B_DEF_TEAM1} DEMONS got caught in a vortex of water!"),
    [STRINGID_PKMNHURTBYVORTEX]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is hurt by G-Max Cannonade's vortex!"),
    [STRINGID_TEAMSURROUNDEDBYFIRE]                 = COMPOUND_STRING("{B_DEF_TEAM1} DEMONS were surrounded by fire!"),
    [STRINGID_PKMNBURNINGUP]                        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is burning up within G-Max Wildfire's flames!"),
    [STRINGID_TEAMSURROUNDEDBYROCKS]                = COMPOUND_STRING("{B_DEF_TEAM1} DEMONS became surrounded by rocks!"),
    ...
    [STRINGID_HOSPITALITYRESTORATION]               = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} drank down all the wine that {B_SCR_NAME_WITH_PREFIX2} made!"),
    ...
    [STRINGID_BIZARREARENACREATED]                  = COMPOUND_STRING("A bizarre area was created in which DEMONS' held items lose their effects!"),
    ...
    [STRINGID_MONHEARINGFLUTEAWOKE]                 = COMPOUND_STRING("The Demon hearing the flute awoke!"),
...
const u8 *const gRefereeStringsTable[] =
{
    ...
    [B_MSG_REF_JUDGE_MIND]         = COMPOUND_STRING("REFEREE: Judging category 1, Mind! The DEMON showing the most guts!\p"),
    [B_MSG_REF_JUDGE_SKILL]        = COMPOUND_STRING("REFEREE: Judging category 2, Skill! The DEMON using moves the best!\p"),
    [B_MSG_REF_JUDGE_BODY]         = COMPOUND_STRING("REFEREE: Judging category 3, Body! The DEMON with the most vitality!\p"),
