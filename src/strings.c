...
const u8 gText_Pokemon[POKEMON_NAME_LENGTH + 1] = _("DEMON");
const u8 gText_Player[] = _("PLAYER"); // Unused
const u8 gText_Pokedex[] = _("COMP"); // Unused
...
const u8 gText_ThisIsAPokemon[] = _("This is what we call a “DEMON.”{PAUSE 96}\p");
const u8 gText_5MarksPokemon[] = _("????? DEMON");
...
const u8 gText_PokedexRegistration[] = _("COMPENDIUM registration completed.");
...
const u8 gText_NoMatchingPkmnWereFound[] = _("No matching DEMONS were found.");
const u8 gText_SearchForPkmnBasedOnParameters[] = _("Search for DEMONS based on\nselected parameters.");
const u8 gText_SwitchPokedexListings[] = _("Switch COMPENDIUM listings.");
const u8 gText_ReturnToPokedex[] = _("Return to the COMPENDIUM.");
const u8 gText_SelectPokedexMode[] = _("Select the COMPENDIUM mode.");
const u8 gText_SelectPokedexListingMode[] = _("Select the COMPENDIUM listing mode.");
...
const u8 gText_DexHoennTitle[] = _("TOKYO COMPENDIUM");
...
const u8 gText_DexHoennDescription[] = _("TOKYO's COMPENDIUM");
const u8 gText_DexNatDescription[] = _("National edition POKéDEX");
const u8 gText_DexSortNumericalDescription[] = _("DEMONS are listed according to their\nnumber.");
const u8 gText_DexSortAtoZDescription[] = _("Spotted and owned DEMONS are listed\nalphabetically.");
const u8 gText_DexSortHeaviestDescription[] = _("Owned DEMONS are listed from the\nheaviest to the lightest.");
const u8 gText_DexSortLightestDescription[] = _("Owned DEMONS are listed from the\nlightest to the heaviest.");
const u8 gText_DexSortTallestDescription[] = _("Owned DEMONS are listed from the\ntallest to the smallest.");
const u8 gText_DexSortSmallestDescription[] = _("Owned DEMONS are listed from the\nsmallest to the tallest.");
...
const u8 gText_HOFDexRating[] = _("Spotted DEMONS: {STR_VAR_1}!\nOwned DEMONS: {STR_VAR_2}!\pPROF. BIRCH's POKéDEX rating!\pPROF. BIRCH: Let's see…\p");
...
const u8 gText_BirchInTrouble[] = _("PROF. BIRCH is in trouble!\nRelease a DEMON and rescue him!");
const u8 gText_ConfirmStarterChoice[] = _("Do you choose this DEMON?");
const u8 gText_Pokemon4[] = _("POKéMON"); // Unused
const u8 gText_FlyToWhere[] = _("RETURN to where?");
...
const u8 gText_ThePokemonList[] = _("the DEMON LIST");
...
const u8 *const gPocketNamesStringsTable[] =
{
    ...
    [POCKET_POKE_BALLS] =   COMPOUND_STRING("DEMON TUBES"),
...
const u8 gText_NoMoreThanVar1Pkmn[] = _("No more than {STR_VAR_1} DEMONS\nmay enter.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ChoosePokemon[] = _("Choose a DEMON.");
const u8 gText_MoveToWhere[] = _("Move to where?");
const u8 gText_TeachWhichPokemon[] = _("Teach which DEMON?");
const u8 gText_UseOnWhichPokemon[] = _("Use on which DEMON?");
const u8 gText_GiveToWhichPokemon[] = _("Give to which DEMON?");
...
const u8 gText_NoPokemonForBattle[] = _("No DEMONS for battle!");
const u8 gText_ChoosePokemon2[] = _("Choose a DEMON.");
const u8 gText_NotEnoughHp[] = _("Not enough HP…");
const u8 gText_PokemonAreNeeded[] = _("{STR_VAR_1} DEMONS are needed.");
const u8 gText_PokemonCantBeSame[] = _("DEMONS can't be the same.");
...
const u8 gText_ChoosePokemonCancel[] = _("Choose DEMON or CANCEL.");
const u8 gText_ChoosePokemonConfirm[] = _("Choose DEMON and confirm.");
const u8 gText_SendWhichMonToPC[] = _("Send which DEMON to the PC?");
...
const u8 gText_PkmnCantParticipate[] = _("That DEMON can't participate.{PAUSE_UNTIL_PRESS}");
...
ALIGNED(4) const u8 gText_PkmnCantBeTradedNow[] = _("That DEMON can't be traded\nnow.");
ALIGNED(4) const u8 gText_PkmnCantBeTraded[] = _("That DEMON can't be traded.");
ALIGNED(4) const u8 gText_EggCantBeTradedNow[] = _("An EGG can't be traded now.");
ALIGNED(4) const u8 gText_OtherTrainersPkmnCantBeTraded[] = _("The other TRAINER's DEMON\ncan't be traded now.");
...
ALIGNED(4) const u8 gText_NotPkmnOtherTrainerWants[] = _("That isn't the type of DEMON\nthat the other TRAINER wants.");
...
const u8 gText_RentalPkmn[] = _("RENTAL DEMON");
...
const u8 gText_PkmnInfo[] = _("DEMON INFO");
const u8 gText_PkmnSkills[] = _("DEMON SKILLS");
...
const u8 gText_OddEggFoundByCouple[] = _("An odd DEMON EGG found\nby the DAY CARE couple.");
const u8 gText_PeculiarEggNicePlace[] = _("A peculiar DEMON EGG\nobtained at the nice place.");
const u8 gText_PeculiarEggTrade[] = _("A peculiar DEMON EGG\nobtained in a trade.");
const u8 gText_EggFromHotSprings[] = _("A DEMON EGG obtained\nat the hot springs.");
const u8 gText_EggFromTraveler[] = _("An odd DEMON EGG\nobtained from a traveler.");
...
const u8 gText_MenuOptionPokedex[] = _("COMPENDIUM");
const u8 gText_MenuOptionPokemon[] = _("DEMONS");
...
const u8 gText_PokemonNature[] = _("DEMON NATURE");
const u8 gText_PokemonMoves[] = _("DEMON MOVES");
const u8 gText_Underpowered[] = _("UNDERPOWERED");
const u8 gText_WhenInDanger[] = _("WHEN IN DANGER");
const u8 gText_BattlePokemon[] = _("BATTLE DEMON");
...
const u8 gText_StopGivingPkmnMail[] = _("Stop giving the DEMON MAIL?");
...
const u8 gText_PokemonTrades[] = _("DEMON TRADES");
...
const u8 gText_Pokemon2[] = _("DEMON");
...
const u8 gText_MenuPokedex[] = _("COMP");
const u8 gText_MenuPokemon[] = _("DEMONS");
...
const u8 gText_DexHoenn[] = _("TOKYO");
...
const u8 gText_Hoenn[] = _("TOKYO");
const u8 gText_OhABite[] = _("Oh! A bite!");
const u8 gText_PokemonOnHook[] = _("A DEMON's on the hook!{PAUSE_UNTIL_PRESS}");
...
const u8 gEasyChatGroupName_Pokemon[] = _("DEMON");
...
const u8 gEasyChatGroupName_Pokemon2[] = _("DEMON2");
...
const u8 gText_RentalPkmn2[] = _("RENTAL DEMON");
const u8 gText_SelectFirstPkmn[] = _("Select the first DEMON.");
const u8 gText_SelectSecondPkmn[] = _("Select the second DEMON.");
const u8 gText_SelectThirdPkmn[] = _("Select the third DEMON.");
...
const u8 gText_TheseThreePkmnOkay[] = _("Are these three DEMONS OK?");
const u8 gText_Yes2[] = _("YES");
const u8 gText_No2[] = _("NO");
const u8 gText_CantSelectSamePkmn[] = _("Can't select same {PKMN}.");
const u8 gText_PkmnSwap[] = _("DEMON SWAP");
const u8 gText_SelectPkmnToSwap[] = _("Select DEMON to swap.");
const u8 gText_SelectPkmnToAccept[] = _("Select DEMON to accept.");
...
const u8 gText_AcceptThisPkmn[] = _("Accept this DEMON?");
