...
{
    HOENN_TO_NATIONAL(MANDRAKE),
    HOENN_TO_NATIONAL(SKOGSRA),
    HOENN_TO_NATIONAL(ALRAUNE),
    HOENN_TO_NATIONAL(CIRONNUP),
    HOENN_TO_NATIONAL(KUDA),
    HOENN_TO_NATIONAL(CHEFEI),
    HOENN_TO_NATIONAL(ZOA),
    HOENN_TO_NATIONAL(GOGMAGOG),
    HOENN_TO_NATIONAL(ALBION),
    HOENN_TO_NATIONAL(PASCAL),
    HOENN_TO_NATIONAL(ORTHRUS),
    HOENN_TO_NATIONAL(CERBERUS),
    HOENN_TO_NATIONAL(KOPPA_TENGU),
    HOENN_TO_NATIONAL(KARASU_TENGU),
    HOENN_TO_NATIONAL(KURAMA_TENGU),
    HOENN_TO_NATIONAL(PIXIE),
    HOENN_TO_NATIONAL(HIGH_PIXIE),
    HOENN_TO_NATIONAL(QUEEN_MAB),
    HOENN_TO_NATIONAL(SLIME),
    HOENN_TO_NATIONAL(BLACK_OOZE),
    HOENN_TO_NATIONAL(GOBLIN),
    HOENN_TO_NATIONAL(DWARF),
    HOENN_TO_NATIONAL(ONGKHOT),
    HOENN_TO_NATIONAL(HANUMAN),
    HOENN_TO_NATIONAL(SUN_WUKONG),
    HOENN_TO_NATIONAL(CHATTERSKULL),
    HOENN_TO_NATIONAL(LOA),
    HOENN_TO_NATIONAL(PETIT_FROST),
    HOENN_TO_NATIONAL(JACK_FROST),
    HOENN_TO_NATIONAL(KING_FROST),
    HOENN_TO_NATIONAL(BLACK_FROST),
    HOENN_TO_NATIONAL(JACK_O_LANTERN),
    HOENN_TO_NATIONAL(JACK_THE_RIPPER),
    HOENN_TO_NATIONAL(UBU),
    HOENN_TO_NATIONAL(TSUCHIGUMO),
    HOENN_TO_NATIONAL(MOTHMAN),
    HOENN_TO_NATIONAL(AGATHION),
    HOENN_TO_NATIONAL(BROWNIE),
    HOENN_TO_NATIONAL(BOGLE),
    HOENN_TO_NATIONAL(KOROPOKKUR),
    HOENN_TO_NATIONAL(SUKUNA_HIKONA),
    HOENN_TO_NATIONAL(MORAX),
    HOENN_TO_NATIONAL(MINOTAUR),
    HOENN_TO_NATIONAL(ANANSI),
    HOENN_TO_NATIONAL(ONYANKOPON),
    HOENN_TO_NATIONAL(NYAMI_NYAMI),
    HOENN_TO_NATIONAL(ANGEL),
    HOENN_TO_NATIONAL(ARCHANGEL),
    HOENN_TO_NATIONAL(ZHU_TUN_SHE),
    HOENN_TO_NATIONAL(NEKOMATA),
    HOENN_TO_NATIONAL(SENRI),
    HOENN_TO_NATIONAL(AMABIE),
    HOENN_TO_NATIONAL(KINMAMON),
    HOENN_TO_NATIONAL(BAKU),
    HOENN_TO_NATIONAL(BUG),
    HOENN_TO_NATIONAL(HAG),
    HOENN_TO_NATIONAL(TURBO_GRANNY),
    HOENN_TO_NATIONAL(AMMUT),
    HOENN_TO_NATIONAL(SOBEK),
    HOENN_TO_NATIONAL(DEAD_LOBSTER),
    HOENN_TO_NATIONAL(FAUN),
    HOENN_TO_NATIONAL(SANDMAN),
    HOENN_TO_NATIONAL(GAGYSON),
    HOENN_TO_NATIONAL(ORIAS),
    HOENN_TO_NATIONAL(ONI),
    HOENN_TO_NATIONAL(AMDUSIAS),
    HOENN_TO_NATIONAL(ES),
    HOENN_TO_NATIONAL(MITAMA),
    HOENN_TO_NATIONAL(CHRIS_THE_CAR),
    HOENN_TO_NATIONAL(AKA_MANAH),
    HOENN_TO_NATIONAL(ANGRA_MAINYU),
    HOENN_TO_NATIONAL(VOHU_MANAH),
    HOENN_TO_NATIONAL(SRAOSHA),
    HOENN_TO_NATIONAL(MADA),
    HOENN_TO_NATIONAL(ALILAT),
    HOENN_TO_NATIONAL(KAMAPUAA),
    HOENN_TO_NATIONAL(PELE),
    HOENN_TO_NATIONAL(ATTIS),
    HOENN_TO_NATIONAL(DIONYSUS),
    HOENN_TO_NATIONAL(NOZUCHI),
    HOENN_TO_NATIONAL(CATOBLEPAS),
    HOENN_TO_NATIONAL(NEKO_SHOGUN),
    HOENN_TO_NATIONAL(YOSHITSUNE),
    HOENN_TO_NATIONAL(THRONE),
    HOENN_TO_NATIONAL(CHERUB),
    HOENN_TO_NATIONAL(SERAPH),
    HOENN_TO_NATIONAL(MOMUNOFU),
    HOENN_TO_NATIONAL(ARAHABAKI),
    HOENN_TO_NATIONAL(THUNDERBIRD),
    HOENN_TO_NATIONAL(HARE_OF_INABA),
    HOENN_TO_NATIONAL(YOWIE),
    HOENN_TO_NATIONAL(MYRMECOLEON),
    HOENN_TO_NATIONAL(OSHIRA_SAMA),
    HOENN_TO_NATIONAL(KAYA_NO_HIME),
    HOENN_TO_NATIONAL(KONOHANA_SAKUYA),
    HOENN_TO_NATIONAL(OUYAMATSUMI),
    HOENN_TO_NATIONAL(CABRACAN),
    HOENN_TO_NATIONAL(GUCUMATZ),
    HOENN_TO_NATIONAL(WENDIGO),
    HOENN_TO_NATIONAL(LILIM),
    HOENN_TO_NATIONAL(LILITH),
    HOENN_TO_NATIONAL(BELIAL),
    HOENN_TO_NATIONAL(NEBIROS),
    HOENN_TO_NATIONAL(ITSUMADE),
    HOENN_TO_NATIONAL(GURULU),
    HOENN_TO_NATIONAL(OBERON),
    HOENN_TO_NATIONAL(TITANIA),
    HOENN_TO_NATIONAL(FAFNIR),
    HOENN_TO_NATIONAL(OCELOT),
    HOENN_TO_NATIONAL(TEZCATLIPOCA),
    HOENN_TO_NATIONAL(NARCISSUS),
    HOENN_TO_NATIONAL(CHERNOBOG),
    HOENN_TO_NATIONAL(TLALOC),
    HOENN_TO_NATIONAL(OMETEOTL),
    HOENN_TO_NATIONAL(NAGA),
    HOENN_TO_NATIONAL(NAGA_RAJA),
    HOENN_TO_NATIONAL(VASUKI),
    HOENN_TO_NATIONAL(NIGHT_STALKER),
    HOENN_TO_NATIONAL(MAD_GASSER),
    HOENN_TO_NATIONAL(SKELETON),
    HOENN_TO_NATIONAL(MATADOR),
    HOENN_TO_NATIONAL(DAISOUJOU),
    HOENN_TO_NATIONAL(HELL_BIKER),
    HOENN_TO_NATIONAL(TRUMPETER),
    HOENN_TO_NATIONAL(MOTHER_HARLOT),
    HOENN_TO_NATIONAL(GNOME),
    HOENN_TO_NATIONAL(BARBEGAZI),
    HOENN_TO_NATIONAL(ZEED),
    HOENN_TO_NATIONAL(OBARIYON),
    HOENN_TO_NATIONAL(PUTZ),
    HOENN_TO_NATIONAL(THOR),
    HOENN_TO_NATIONAL(ODIN),
    HOENN_TO_NATIONAL(LOKI),
    HOENN_TO_NATIONAL(HEL),
    HOENN_TO_NATIONAL(YUKI_JYOROU),
    HOENN_TO_NATIONAL(LOUP_GAROU),
    HOENN_TO_NATIONAL(DAGDA),
    HOENN_TO_NATIONAL(AZUMI),
    HOENN_TO_NATIONAL(ISORA),
    HOENN_TO_NATIONAL(FORNEUS),
    HOENN_TO_NATIONAL(DECARABIA),
    HOENN_TO_NATIONAL(SETANTA),
    HOENN_TO_NATIONAL(CU_CHULAINN),
    HOENN_TO_NATIONAL(AIRAVATA),
    HOENN_TO_NATIONAL(GIRIMEKHALA),
    HOENN_TO_NATIONAL(THANATOS),
    HOENN_TO_NATIONAL(MOT),
    HOENN_TO_NATIONAL(THOTH),
    HOENN_TO_NATIONAL(KHONSU),
    HOENN_TO_NATIONAL(MIZUCHI),
    HOENN_TO_NATIONAL(YURLUNGUR),
    HOENN_TO_NATIONAL(STOLAS),
    HOENN_TO_NATIONAL(ANDRAS),
    HOENN_TO_NATIONAL(AMON),
    HOENN_TO_NATIONAL(MASTEMA),
    HOENN_TO_NATIONAL(BAIHU),
    HOENN_TO_NATIONAL(XUANWU),
    HOENN_TO_NATIONAL(QING_LONG),
    HOENN_TO_NATIONAL(ZHUQUE),
    HOENN_TO_NATIONAL(HUANG_LONG),
    HOENN_TO_NATIONAL(BEELZEBUB),
    HOENN_TO_NATIONAL(METATRON),
    HOENN_TO_NATIONAL(AMANOZAKO),
    HOENN_TO_NATIONAL(DANTE),
    HOENN_TO_NATIONAL(SHIVA),
};
